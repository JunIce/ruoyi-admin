<template>
  <div class="app-container">
    ...
    <!-- 表格数据 -->
    <v-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
    ...
    <!-- 分配角色数据权限对话框 -->
    <v-dialog :title="title" v-model="openDataScope" width="500px" append-to-body>
...
const columns = ref([
  { prop: "roleId", label: "角色编号", visible: true },
  { prop: "roleName", label: "角色名称", visible: true },
  { prop: "roleKey", label: "权限字符", visible: true },
  { prop: "roleSort", label: "角色顺序", visible: true },
