<template>
   <div class="app-container">
      ...
      <v-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
...
const columns = ref([
   { prop: "configId", label: "参数主键", visible: true },
   { prop: "configName", label: "参数名称", visible: true },
   { prop: "configKey", label: "参数键名", visible: true },
   { prop: "configValue", label: "参数键值", visible: true },
   { prop: "configType", label: "系统内置", visible: true },
