<template>
   <div class="app-container">
      ...
      <v-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <!-- 添加或修改定时任务对话框 -->
      <v-dialog :title="title" v-model="open" width="820px" append-to-body>
      ...
      <v-dialog title="Cron表达式生成器" v-model="openCron" append-to-body destroy-on-close>
         <crontab ref="crontabRef" @hide="openCron = false" @fill="crontabFill" :expression="expression"></crontab>
      </v-dialog>

      <!-- 任务日志详细 -->
      <v-dialog title="任务详细" v-model="openView" width="700px" append-to-body>
